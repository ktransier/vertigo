...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovieList = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var moviesArray = movies.map(function (movie) {
	      return React.createElement(MovieRow, { title: movie.title, director: movie.director, year: movie.year });
	    });
	...
	ReactDOM.render(React.createElement(MovieListApp, { data: movies }), document.getElementById("app"));
